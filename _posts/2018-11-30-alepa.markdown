...
Based on our research we compiled [personas][personas] and I mapped the [customer journey][journey] using **Lucidchart** along with the [stakeholder map][stakeholders].
